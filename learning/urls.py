...
urlpatterns = [
    ...
    path('my-courses/', views.my_courses, name='my_courses'), # Lists all enrolled courses
    path("track-progress/", views.track_progress, name="track_progress"), # Track learning time
